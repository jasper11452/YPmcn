...
const briefs = [
  { brief_id: "B01", scenario: "母婴亲子 (千问61儿童节 style)", content_requirements: ["母婴", "亲子互动", "新手妈妈", "儿童节"], negative_requirements: [], platform: "xiaohongshu", geo: null, relevance_keywords: ["母婴", "亲子", "育儿", "妈妈", "辣妈", "宝宝", "儿童", "幼儿", "母婴用品", "母婴类", "亲子类", "亲子互动", "新手妈妈", "全职妈妈", "母婴亲子", "宝妈", "宝贝", "萌娃", "亲子育儿", "婴幼", "早教", "宝宝穿搭", "宝宝日常", "宝宝食谱", "儿童礼物", "儿童教育", "toddler", "婴儿", "童装", "童品", "母婴号"] },
  { brief_id: "B02", scenario: "时尚穿搭 + 探店 + 沈阳 (安踏沈阳 style)", content_requirements: ["时尚穿搭", "OOTD", "探店", "沈阳"], negative_requirements: [], platform: "xiaohongshu", geo: "沈阳", relevance_keywords: ["穿搭", "时尚", "OOTD", "搭配", "服饰", "服装", "街拍", "潮", "显瘦", "显高", "时尚穿搭", "日常穿搭", "通勤穿搭", "职场穿搭", "平价穿搭", "韩系穿搭", "运动穿搭", "街头穿搭", "时尚博主", "探店", "沈阳", "沈阳探店", "沈阳打卡", "沈阳穿搭", "本地生活", "沈阳本地生活", "东北", "辽沈", "沈城"] },
  { brief_id: "B03", scenario: "食品测评 + 广东 (金龙鱼 style)", content_requirements: ["食品测评", "厨房好物", "广东"], negative_requirements: [], platform: "douyin", geo: "广东", relevance_keywords: ["食品", "测评", "厨房", "美食", "零食", "烘焙", "料理", "菜谱", "食材", "调味", "粮油", "食品测评", "厨房好物", "美食测评", "食品饮料", "零食测评", "家常菜", "做饭", "吃播", "探店", "广东", "粤", "粤语", "广东本土", "广州", "深圳", "粤菜", "广东话", "广式", "广式美食", "广东菜", "顺德"] },
  { brief_id: "B04", scenario: "AI科技/知识 (AI教程/数码测评)", content_requirements: ["AI深度使用", "AI教程", "科技测评", "数码"], negative_requirements: [], platform: "xiaohongshu", geo: null, relevance_keywords: ["AI", "数码", "科技", "测评", "知识", "教程", "编程", "智能", "人工智能", "机器学习", "深度学习", "AI教程", "AI深度使用", "科技测评", "数码测评", "效率工具", "创作者成长", "知识分享", "科普", "电子产品", "开箱", "横评", "对比测评", "AI应用", "AI工具", "AI绘画", "ChatGPT", "大模型", "AI博主"] },
  { brief_id: "B05", scenario: "颜值/P图教程", content_requirements: ["颜值", "P图教程", "修图"], negative_requirements: [], platform: "xiaohongshu", geo: null, relevance_keywords: ["颜值", "P图", "修图", "美颜", "滤镜", "拍照", "摄影", "后期", "图像", "P图教程", "修图教程", "调色", "人像修图", "自拍", "写真", "颜值博主", "颜值类", "颜值号", "美照", "拍照技巧", "出片", "氛围感", "拍照姿势"] },
  { brief_id: "B06", scenario: "健身/运动户外", content_requirements: ["运动户外", "运动装备", "健身"], negative_requirements: [], platform: "douyin", geo: null, relevance_keywords: ["健身", "运动", "户外", "跑步", "瑜伽", "器械", "训练", "健美", "运动户外", "运动装备", "户外运动", "健身博主", "运动博主", "减脂", "增肌", "塑形", "马拉松", "越野", "徒步", "登山", "骑行", "滑雪", "冲浪", "潜水", "飞盘", "露营"] },
  { brief_id: "B07", scenario: "剧情/搞笑 (dy vertical match)", content_requirements: ["剧情", "搞笑", "段子"], negative_requirements: [], platform: "douyin", geo: null, relevance_keywords: ["剧情", "搞笑", "段子", "沙雕", "整蛊", "恶作剧", "戏精", "扮傻", "诙谐", "幽默", "反转", "情景剧", "情侣日常", "街头采访", "搞笑博主", "剧情号", "段子手", "娱乐博主", "整活", "爆笑", "逗趣", "欢乐", "戏精博主", "沙雕博主"] },
  { brief_id: "B08", scenario: "本地生活 + 探店 (dy generic)", content_requirements: ["本地生活", "探店", "美食"], negative_requirements: [], platform: "douyin", geo: null, relevance_keywords: ["探店", "本地", "美食", "餐厅", "咖啡", "打卡", "网红", "吃货", "本地生活", "本地探店", "美食探店", "美食博主", "美食达人", "探店达人", "探店博主", "餐饮", "美食推荐", "美食分享", "吃播", "美食测评", "下饭", "深夜食堂"] },
  { brief_id: "B09", scenario: "美妆护肤 (xhs extra)", content_requirements: ["美妆", "护肤", "好物分享"], negative_requirements: [], platform: "xiaohongshu", geo: null, relevance_keywords: ["美妆", "护肤", "化妆", "彩妆", "口红", "粉底", "眼影", "面膜", "精华", "面霜", "水乳", "洁面", "卸妆", "防晒", "隔离", "美妆博主", "护肤博主", "成分党", "敏感肌", "平价彩妆", "化妆教程", "学生党", "彩妆教程", "日常妆容", "妆容分享", "好物分享", "种草", "测评", "新品"] },
  { brief_id: "B10", scenario: "剧情/搞笑 (xhs extra)", content_requirements: ["剧情", "搞笑", "段子"], negative_requirements: [], platform: "xiaohongshu", geo: null, relevance_keywords: ["剧情", "搞笑", "段子", "沙雕", "整蛊", "恶作剧", "戏精", "扮傻", "诙谐", "幽默", "反转", "情景剧", "情侣日常", "搞笑博主", "剧情号", "段子手", "娱乐博主", "整活", "爆笑", "日常", "生活", "分享"] },
];
