...
### 3. `confirm-supply-ratio` — MCN/野生比例确认
...
### 4. `mcn-select-for-wechat` — MCN 名单确认
...
### 6. `confirm-wecom-permission` — 企微角色权限 gate
...
### 10. `confirm-risky-submission` — 风险账号提报确认
