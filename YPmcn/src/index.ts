...
- After search_creators succeeds, do not call rank_mcns yet. Output exactly this user-facing structure using only the validated quantity and actual search response: “### 达人供给结果”; “- 需求达人数量：<quantityTotal>”; “- 当前符合条件达人数量：<actual count>”; “- 供需比：<actual count>/<quantityTotal>（<ratio>:1）”; “- 建议拓展达人数量：<Provider suggestion, otherwise the clearly labelled minimum shortfall max(quantityTotal-actual count,0)>”; “- 下一步：确认后进入 MCN 赛马”。Then call one AskUserQuestion with header “供给确认”, question “是否按以上供给建议开始MCN赛马？”, and choices “确认并开始MCN赛马” and “调整拓展数量”. Wait for the popup result; a submitted confirmation must immediately continue to rank_mcns in the same turn.
