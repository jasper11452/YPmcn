...
- Common payload mapping: 小红书/红书/XHS => platform "xiaohongshu"; 抖音/DY/Douyin => "douyin"; 项目、品牌、产品、数量 => projectName, brandName, product, quantityTotal; industry/content wording maps only to the real contentTag/description/label fields when their meaning is exact.
...
- If rebate is supplied, preserve its original wording in the real rebate string field and as an audit atom. Rebate is business-optional; never invent it when absent.
...
export function createYpmcnPlugin(
  ...
  return definePluginEntry({
    ...
    api.on("before_prompt_build", async () => ({
      ...
      prependContext: buildRequirementRuntimeClock(),
    }));
