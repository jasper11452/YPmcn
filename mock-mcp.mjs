...
const TOOLS = [
  ...
  { name: "search_creators", description: "搜索创作者", inputSchema: { type: "object", properties: { demand_id: { type: "string" }, demand_version: { type: "number" }, platform: { type: "string" }, category_requirements: { type: "array", items: { type: "string" } } } } },
  { name: "rank_mcns", description: "MCN 排序", inputSchema: { type: "object", properties: { demand_id: { type: "string" }, demand_version: { type: "number" }, platform: { type: "string" }, medium_risk_confirmed: { type: "boolean" } } } },
  ...
  { name: "rank_creators", description: "创作者精排", inputSchema: { type: "object", properties: { demand_id: { type: "string" }, demand_version: { type: "number" }, platform: { type: "string" } } } },
  ...
  { name: "manual_source_creators", description: "手动补充创作者", inputSchema: { type: "object", properties: { demand_id: { type: "string" }, creator_ids: { type: "array", items: { type: "string" } } } } },
